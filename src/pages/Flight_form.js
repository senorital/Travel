...
function Flight_form(){
    ...
    const handleFormSubmit = (e) => {
      ...
      navigate(`/Flight_result1?from=${formData.from}&to=${formData.to}&journeyDate=${formData.datePicker}`);
    };
    ...
    <div id="flight_form" style={{display:'none'}}>
     ...
     {/* <input type="date" name="trip_start_date" id="datepicker"  class="formRow--input js-input" autocomplete="off" value=''/> */}
     <input
        type="date"
        id="datePicker"
        name="datePicker"
...
<div class="formRow--item">
<label for="date" class="formRow--input-wrapper js-inputWrapper">
<input type="text" name="trip_end_date" id="dateNewRet" readonly class="formRow--input js-input" autocomplete="off" value="17/09/2023" placeholder="Return Date"/>
<i class="zmdi zmdi-calendar-alt zmdi-hc-2x icf"></i>
